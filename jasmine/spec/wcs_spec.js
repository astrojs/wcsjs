...
// FLAT HEADERS
	...
	it ("ARC Projection - flat", function() {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("SIN Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("STG Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
    ...
    it ("TAN Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
    ...
    it ("ZEA Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	// Cylindrical Projections
	//
	it ("CYP Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("CEA Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("CAR Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("MER Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("SFL Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("PAR Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("MOL Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
	...
	it ("AIT Projection - flat", function () {
		var wcs, pixels, sky, i, coords;
		pixels = [];
		sky = [];
