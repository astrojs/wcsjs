(function() {
  ...
  WCS.Mapper = (function() {
    ...
    Mapper.prototype.setProjection = function(header) {
      var conic, cylindrical, key, key1, key2, key3, polyConic, quadCube, zenithal, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
        _this = this;
      ...
      if (_ref = this.projection, __indexOf.call(zenithal, _ref) >= 0) {
        ...
        switch (this.projection) {
          ...
          case 'NCP':
            ...
            break;
          case 'SIN':
            _ref3 = ["PV" + this.latitudeAxis + "_1", "PV" + this.latitudeAxis + "_2"], key1 = _ref3[0], key2 = _ref3[1];
          ...
          case 'STG':
            ...
            break;
          case 'SZP':
            _ref4 = ["PV" + this.latitudeAxis + "_1", "PV" + this.latitudeAxis + "_2", "PV" + this.latitudeAxis + "_3"], key1 = _ref4[0], key2 = _ref4[1], key3 = _ref4[2];
            this.wcsobj.mu = header.hasOwnProperty(key1) ? parseFloat(header[key1]) : 0;
          ...
          case 'TAN-SIP':
            ...
            this.toIntermediate = function(points) {
              var dx, dy, i, j, proj, u, v, _ref5, _ref6;
              proj = [];
              ...
              for (i = 0, _ref5 = _this.wcsobj.naxis - 1; 0 <= _ref5 ? i <= _ref5 : i >= _ref5; 0 <= _ref5 ? i++ : i--) {
                proj[i] = 0;
                points[i] -= _this.wcsobj.crpix[i];
                for (j = 0, _ref6 = _this.wcsobj - 1; 0 <= _ref6 ? j <= _ref6 : j >= _ref6; 0 <= _ref6 ? j++ : j--) {
            ...
            this.fromIntermediate = function(proj) {
              var dx, dy, i, j, points, tmp, _ref5, _ref6;
              tmp = [];
              for (i = 0, _ref5 = _this.wcsobj.naxis - 1; 0 <= _ref5 ? i <= _ref5 : i >= _ref5; 0 <= _ref5 ? i++ : i--) {
                tmp[i] = 0;
                for (j = 0, _ref6 = _this.wcsobj.naxis - 1; 0 <= _ref6 ? j <= _ref6 : j >= _ref6; 0 <= _ref6 ? j++ : j--) {
      ...
      if (_ref5 = this.projection, __indexOf.call(cylindrical, _ref5) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        this.computeCelestialParameters(this.wcsobj.phi0, this.wcsobj.theta0);
        switch (this.projection) {
          case 'CYP':
            _ref6 = ["PV" + this.latitudeAxis + "_1,", "PV" + this.latitudeAxis + "_2"], key1 = _ref6[0], key2 = _ref6[1];
      ...
      if (_ref7 = this.projection, __indexOf.call(conic, _ref7) >= 0) {
        key = "PV" + this.latitudeAxis + "_1";
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = header.hasOwnProperty(key) ? header[key] : 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref8 = this.projection, __indexOf.call(polyConic, _ref8) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref9 = this.projection, __indexOf.call(quadCube, _ref9) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
