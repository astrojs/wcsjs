(function() {
  ...
  WCS.Mapper = (function() {
    ...
    Mapper.prototype.checkCard = function(header, key, dimensions) {
      ...
      for (i = 1; 1 <= dimensions ? i <= dimensions : i >= dimensions; 1 <= dimensions ? i++ : i--) {
        ...
        for (j = 1; 1 <= dimensions ? j <= dimensions : j >= dimensions; 1 <= dimensions ? j++ : j--) {
          fullKey = "" + key + i + "_" + j;
          if (!header.hasOwnProperty(fullKey)) return;
    ...
    Mapper.prototype.derivePC = function(header) {
      var cd, cdDet, cdSign, crota, lambda, _ref;
    ...
    Mapper.prototype.setProjection = function(header) {
      var conic, cylindrical, key, key1, key2, key3, polyConic, quadCube, zenithal, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7,
        _this = this;
      ...
      if (_ref = this.projection, __indexOf.call(zenithal, _ref) >= 0) {
        ...
        switch (this.projection) {
          ...
          case 'STG':
            ...
            break;
          case 'SZP':
            _ref2 = ["PV" + this.latitudeAxis + "_1,", "PV" + this.latitudeAxis + "_2", "PV" + this.latitudeAxis + "_3"], key1 = _ref2[0], key2 = _ref2[1], key3 = _ref2[2];
            ...
            console.log(this.wcsobj.mu, this.wcsobj.phiC, this.wcsobj.thetaC);
          ...
          case 'TAN-SIP':
            ...
            this.f = function(u, v, coeffs) {
              ...
              for (p = 0; 0 <= order ? p <= order : p >= order; 0 <= order ? p++ : p--) {
                for (q = 0; 0 <= order ? q <= order : q >= order; 0 <= order ? q++ : q--) {
            ...
            this.toIntermediate = function(points) {
              var dx, dy, i, j, proj, u, v, _ref3, _ref4;
              proj = [];
              ...
              for (i = 0, _ref3 = _this.wcsobj.naxis - 1; 0 <= _ref3 ? i <= _ref3 : i >= _ref3; 0 <= _ref3 ? i++ : i--) {
                proj[i] = 0;
                points[i] -= _this.wcsobj.crpix[i];
                for (j = 0, _ref4 = _this.wcsobj - 1; 0 <= _ref4 ? j <= _ref4 : j >= _ref4; 0 <= _ref4 ? j++ : j--) {
            ...
            this.fromIntermediate = function(proj) {
              var dx, dy, i, j, points, tmp, _ref3, _ref4;
              tmp = [];
              for (i = 0, _ref3 = _this.wcsobj.naxis - 1; 0 <= _ref3 ? i <= _ref3 : i >= _ref3; 0 <= _ref3 ? i++ : i--) {
                tmp[i] = 0;
                for (j = 0, _ref4 = _this.wcsobj.naxis - 1; 0 <= _ref4 ? j <= _ref4 : j >= _ref4; 0 <= _ref4 ? j++ : j--) {
      ...
      if (_ref3 = this.projection, __indexOf.call(cylindrical, _ref3) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 90;
        this.computeCelestialParameters(this.wcsobj.phi0, this.wcsobj.theta0);
        switch (this.projection) {
          case 'CYP':
            _ref4 = ["PV" + this.latitudeAxis + "_1,", "PV" + this.latitudeAxis + "_2"], key1 = _ref4[0], key2 = _ref4[1];
      ...
      if (_ref5 = this.projection, __indexOf.call(conic, _ref5) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = header.hasOwnProperty('PV2_1') ? header['PV2_1'] : 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref6 = this.projection, __indexOf.call(polyConic, _ref6) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref7 = this.projection, __indexOf.call(quadCube, _ref7) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
    ...
    Mapper.prototype.getSipCoefficients = function(header) {
      var i, j, key, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      this.sip.apCoeffs = [];
      this.sip.bpCoeffs = [];
      for (i = 0, _ref = this.sip.aOrder; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
        this.sip.aCoeffs[i] = [];
        for (j = 0, _ref2 = this.sip.aOrder; 0 <= _ref2 ? j <= _ref2 : j >= _ref2; 0 <= _ref2 ? j++ : j--) {
          key = "A_" + i + "_" + j;
          this.sip.aCoeffs[i][j] = header[key] || 0;
        }
      }
      for (i = 0, _ref3 = this.sip.bOrder; 0 <= _ref3 ? i <= _ref3 : i >= _ref3; 0 <= _ref3 ? i++ : i--) {
        this.sip.bCoeffs[i] = [];
        for (j = 0, _ref4 = this.sip.bOrder; 0 <= _ref4 ? j <= _ref4 : j >= _ref4; 0 <= _ref4 ? j++ : j--) {
          key = "B_" + i + "_" + j;
          this.sip.bCoeffs[i][j] = header[key] || 0;
        }
      }
      for (i = 0, _ref5 = this.sip.apOrder; 0 <= _ref5 ? i <= _ref5 : i >= _ref5; 0 <= _ref5 ? i++ : i--) {
        this.sip.apCoeffs[i] = [];
        for (j = 0, _ref6 = this.sip.apOrder; 0 <= _ref6 ? j <= _ref6 : j >= _ref6; 0 <= _ref6 ? j++ : j--) {
          key = "AP_" + i + "_" + j;
          this.sip.apCoeffs[i][j] = header[key] || 0;
        }
      }
      for (i = 0, _ref7 = this.sip.bpOrder; 0 <= _ref7 ? i <= _ref7 : i >= _ref7; 0 <= _ref7 ? i++ : i--) {
        this.sip.bpCoeffs[i] = [];
        for (j = 0, _ref8 = this.sip.bpOrder; 0 <= _ref8 ? j <= _ref8 : j >= _ref8; 0 <= _ref8 ? j++ : j--) {
          key = "BP_" + i + "_" + j;
    ...
    Mapper.prototype.computeCelestialParameters = function(phi0, theta0) {
      var alpha0, delta0, deltaP1, deltaP2, dist1, dist2, phiP, sol1, sol2, thetaP, _ref, _ref2;
      _ref = this.wcsobj.crval, alpha0 = _ref[0], delta0 = _ref[1];
      _ref2 = [this.wcsobj.lonpole, this.wcsobj.latpole], phiP = _ref2[0], thetaP = _ref2[1];
      ...
      return this.wcsobj.alphaP = delta0 === 90 ? alpha0 : alpha0 - WCS.Math.asind(WCS.Math.sind(phiP - this.wcsobj.phi0) * WCS.Math.cosd(this.wcsobj.theta0) / WCS.Math.cosd(delta0));
    };
