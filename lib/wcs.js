(function() {
  ...
  WCS.Mapper = (function() {
    ...
    Mapper.prototype.setProjection = function(header) {
      var conic, cylindrical, key1, key2, polyConic, quadCube, zenithal, _ref, _ref2, _ref3, _ref4, _ref5, _ref6,
        _this = this;
        ...
        switch (this.projection) {
          ...
          case 'TAN-SIP':
            ...
            this.toIntermediate = function(points) {
              var dx, dy, i, j, proj, u, v, _ref2, _ref3;
              proj = [];
              ...
              for (i = 0, _ref2 = _this.wcsobj.naxis - 1; 0 <= _ref2 ? i <= _ref2 : i >= _ref2; 0 <= _ref2 ? i++ : i--) {
                proj[i] = 0;
                points[i] -= _this.wcsobj.crpix[i];
                for (j = 0, _ref3 = _this.wcsobj - 1; 0 <= _ref3 ? j <= _ref3 : j >= _ref3; 0 <= _ref3 ? j++ : j--) {
            ...
            this.fromIntermediate = function(proj) {
              var dx, dy, i, j, points, tmp, _ref2, _ref3;
              tmp = [];
              for (i = 0, _ref2 = _this.wcsobj.naxis - 1; 0 <= _ref2 ? i <= _ref2 : i >= _ref2; 0 <= _ref2 ? i++ : i--) {
                tmp[i] = 0;
                for (j = 0, _ref3 = _this.wcsobj.naxis - 1; 0 <= _ref3 ? j <= _ref3 : j >= _ref3; 0 <= _ref3 ? j++ : j--) {
      ...
      if (_ref2 = this.projection, __indexOf.call(cylindrical, _ref2) >= 0) {
        ...
        switch (this.projection) {
          case 'CYP':
            _ref3 = ["PV" + this.latitudeAxis + "_1,", "PV" + this.latitudeAxis + "_1"], key1 = _ref3[0], key2 = _ref3[1];
      ...
      if (_ref4 = this.projection, __indexOf.call(conic, _ref4) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = header.hasOwnProperty('PV2_1') ? header['PV2_1'] : 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref5 = this.projection, __indexOf.call(polyConic, _ref5) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
      if (_ref6 = this.projection, __indexOf.call(quadCube, _ref6) >= 0) {
        this.wcsobj.phi0 = 0;
        this.wcsobj.theta0 = 0;
        throw 'Sorry, not yet implemented!';
      }
